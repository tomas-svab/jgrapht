...
/**
 * Test is exactly the same as HopcroftKarpBipartiteMatchingTest
 * (only for different Hopcroft Karp implementation).
 * 
 * @author Tomas Svab
 */
public class HopcroftKarpSimpleTest extends TestCase {
	...
	public void testBipartiteMatching1(){
		...
		HopcroftKarpSimple<Integer,DefaultEdge> bm = new HopcroftKarpSimple<Integer,DefaultEdge>(graph,new HashSet<Integer>(partition1));
